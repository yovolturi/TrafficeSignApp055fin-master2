...
public class AboutMeActivity extends AppCompatActivity {
   MediaPlayer mediaPlayer;
    ...
    public void link1(View view) {
        Intent fbIntent = new Intent(Intent.ACTION_VIEW);
        fbIntent.setData(Uri.parse("https://www.facebook.com/tae.insagul"));
        startActivity(fbIntent);
    }

    public void link2(View view) {
        Intent fbIntent = new Intent(Intent.ACTION_VIEW);
        fbIntent.setData(Uri.parse("https://www.facebook.com/mez.rtc"));
        startActivity(fbIntent);
    }

    public void link3(View view) {
        Intent fbIntent = new Intent(Intent.ACTION_VIEW);
        fbIntent.setData(Uri.parse("https://www.facebook.com/profile.php?id=100010233977571"));
        startActivity(fbIntent);
    }
}
